...
'''
File for training or testing the first corpus.
'''

from datasets.facebook import data
import data_utils

EN_WHITELIST = '0123456789abcdefghijklmnopqrstuvwxyz ' # space is included in whitelist

# load preprocessed data from pickle and npy files
metadata, idx_q, idx_a = data.load_data(PATH='datasets/facebook/')
...
if mode is 'newtraining':
    ...
    f = open("datasets/facebook/testing.txt", "w")
    f.writelines(lines)
    f.close()
